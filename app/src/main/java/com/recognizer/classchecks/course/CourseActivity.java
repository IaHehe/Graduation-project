...
import com.recognizer.common.widget.syllabus.model.SyllabusDao;
...
public class CourseActivity extends BaseActivity<CourseView, CoursePresenter>
    ...
    // 标记是否加载课表，如果没有，在屏幕可见时加载数据，如果已经加载过了，下次屏幕可见时不在加载
    // 减少Http请求
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSyllabusBodyView = (SyllabusBodyView) findViewById(R.id.sbv_show_course);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ll_show_week_list_course:
