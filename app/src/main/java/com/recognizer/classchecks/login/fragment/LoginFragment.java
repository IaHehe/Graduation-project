...
public class LoginFragment extends BaseFragment<LoginFragmentView, LoginFragmentPresenter> implements LoginFragmentView{
    ...
    public void initView() {
        ...
        btnSMSCode = (Button) mView.findViewById(R.id.btn_login_sms_code);
        btnSMSCode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                phone = etPhone.getText().toString();
                mPresenter.reqSMSCode(); // 请求验证码
            }
        });
    ...
    public void showLoading() {
        mDialog = LoadingDialogUtils.createLoadingDialog(getContext(), "");
    }
    ...
    @Override
    public void showResult(int what, final String msg) {
        ...
        //toast(mLoginActivity,message, SHORT_SHOW);
    }
    ...
    @Override
    public void infoCache(StudentBean studentBean) {
        PrefManager.setBoolean(getContext(), PrefManager.AUTO_LOGIN_SIGN, true);
        PrefManager.setString(getContext(), PrefManager.LOGIN_ACCOUNT, studentBean.getSecurityAccount());
        PrefManager.setString(getContext(), PrefManager.LOGIN_SMS_CODE, studentBean.getSecuritSmsCode());
        PrefManager.setInt(getContext(), PrefManager.USER_TYPE, studentBean.getSecuritType());
        PrefManager.setInt(getContext(), PrefManager.FACE_LABLE, studentBean.getFaceLabel());
        PrefManager.setString(getContext(), PrefManager.JW_ACCOUNT, studentBean.getJwAccount());
    }
}
