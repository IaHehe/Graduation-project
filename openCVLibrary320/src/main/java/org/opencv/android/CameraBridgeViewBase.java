...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    // by DongjunZou 2017/3/30 1:24
    // --------------------------------------------------------
    /*public void onEnterStoppedState() {
        *//* nothing to do *//*
    }
    ...
    protected void deliverAndDrawFrame(CvCameraViewFrame frame) {
        ...
        if (modified != null) {
            try {
                //---------------------------------------
                bitmap = Bitmap.createBitmap(modified.width(), modified.height(), Bitmap.Config.ARGB_8888);
